...
switch($_GET[act]){
  ...
  default:
    echo "<h2>User</h2><hr>
          <table>
          <tr><th>no</th><th>username</th><th>nama lengkap</th><th>email</th><th>umur</th><th>jk</th><th>pekerjaan</th><th>alamat</th><th>aksi</th></tr>"; 
  ...
  case "tambahuser":
    echo "<h2>Tambah User</h2>
          ...
          <tr><td>Umur</td>       <td> : <input type=text name='email' size=30></td></tr>
          <tr><td>JK</td>       <td> : <input type=text name='email' size=30></td></tr>
          <tr><td>Pekerjaan</td>       <td> : <input type=text name='email' size=30></td></tr>
          <tr><td>Alamat</td>       <td> : <input type=text name='email' size=30></td></tr>
